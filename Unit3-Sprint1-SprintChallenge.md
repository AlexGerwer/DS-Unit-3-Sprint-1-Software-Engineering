...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  concerns) is important becauseoften such errors are much easier to spot for 
  ...
  formatting changes.  Finally, I am a strong believer in proper naming. I have 
  often heard from less experienced software engineers that the naming of 
...
- We have an awful lot of computers here, and it gets pretty confusing with
  ...
  container with its own separate environment containing the iteself application and 
  everything that application needs to run.  Containers also increase speed from 
  development to deployment by removing technical dependencies that are either 
